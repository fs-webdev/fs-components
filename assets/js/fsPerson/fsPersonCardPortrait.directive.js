/**
 * Output a person's portrait with their gender and vitals (name, lifeSpan, and id) in person card format.
 ...
 * @since 1.1.0
 */
fsModules.registerDirective('fsPersonCardPortrait', ['person', 'options', function(person, options) {
  var scope = fsPersonCardPortraitViewModel({person: person, options: options});
  ...
  var templateStr = templateList.fsPersonCardPortrait;
